  ...
  return (
    <div className={styles.section}>
      ...
      <p className={styles.descriptor}>
        ...
        high-quality, user-friendly applications that prioritize simplicity and
        reliability. Currently, I hold the position of Sr. Systems Engineer at
        SaltShaker Media, where I channel my expertise into developing top-notch
        applications tailored to assist churches and ministries in their digital
        endeavors.
      </p>
    </div>
  );
